...
type Props = {
  ...
  entityId: string
  /** Tipo do documento que este painel envia. */
  kind: AttachmentKind
  /** Rótulo do botão de envio, ex.: "Anexar nota fiscal". */
  uploadLabel: string
}

export function AttachmentsPanel({ entityType, entityId, kind, uploadLabel }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="text-xs text-slate-500">JPEG, PNG, WebP ou PDF · até 15 MB</span>
      </div>
